...
class InvitesApi
{
     ...
     * @param  \InfinityFree\DiscourseApi\Model\InlineObject9 $inlineObject9 inlineObject9 (optional)
     *
     * @throws \InfinityFree\DiscourseApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \InfinityFree\DiscourseApi\Model\InlineResponse20015
     */
    public function createInvite($apiKey, $apiUsername, $inlineObject9 = null)
    {
        list($response) = $this->createInviteWithHttpInfo($apiKey, $apiUsername, $inlineObject9);
        return $response;
    }
     ...
     * @param  \InfinityFree\DiscourseApi\Model\InlineObject9 $inlineObject9 (optional)
     *
     * @throws \InfinityFree\DiscourseApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \InfinityFree\DiscourseApi\Model\InlineResponse20015, HTTP status code, HTTP response headers (array of strings)
     */
    public function createInviteWithHttpInfo($apiKey, $apiUsername, $inlineObject9 = null)
    {
        $request = $this->createInviteRequest($apiKey, $apiUsername, $inlineObject9);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\InfinityFree\DiscourseApi\Model\InlineResponse20015' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\InfinityFree\DiscourseApi\Model\InlineResponse20015', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\InfinityFree\DiscourseApi\Model\InlineResponse20015';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\InfinityFree\DiscourseApi\Model\InlineResponse20015',
     ...
     */
    public function createInviteAsync($apiKey, $apiUsername, $inlineObject9 = null)
    {
        return $this->createInviteAsyncWithHttpInfo($apiKey, $apiUsername, $inlineObject9)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInviteAsyncWithHttpInfo($apiKey, $apiUsername, $inlineObject9 = null)
    {
        $returnType = '\InfinityFree\DiscourseApi\Model\InlineResponse20015';
        $request = $this->createInviteRequest($apiKey, $apiUsername, $inlineObject9);
     ...
     */
    public function createInviteRequest($apiKey, $apiUsername, $inlineObject9 = null)
    {
        // verify the required parameter 'apiKey' is set
        if ($apiKey === null || (is_array($apiKey) && count($apiKey) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiKey when calling createInvite'
            );
        }
        // verify the required parameter 'apiUsername' is set
        if ($apiUsername === null || (is_array($apiUsername) && count($apiUsername) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $apiUsername when calling createInvite'
            );
        }

        $resourcePath = '/invites.json';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
