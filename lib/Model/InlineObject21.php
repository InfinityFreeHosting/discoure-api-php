...
class InlineObject21 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    const NOTIFICATION_LEVEL__0 = '0';
    const NOTIFICATION_LEVEL__1 = '1';
    const NOTIFICATION_LEVEL__2 = '2';
    const NOTIFICATION_LEVEL__3 = '3';
     ...
     * @return string[]
     */
    public function getNotificationLevelAllowableValues()
    {
        return [
            self::NOTIFICATION_LEVEL__0,
            self::NOTIFICATION_LEVEL__1,
            self::NOTIFICATION_LEVEL__2,
            self::NOTIFICATION_LEVEL__3,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getNotificationLevelAllowableValues();
        if (!is_null($this->container['notificationLevel']) && !in_array($this->container['notificationLevel'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'notificationLevel', must be one of '%s'",
                $this->container['notificationLevel'],
     ...
     *
     * @param string $notificationLevel notificationLevel
     *
     * @return self
     */
    ...
    {
        $allowedValues = $this->getNotificationLevelAllowableValues();
        if (!in_array($notificationLevel, $allowedValues, true)) {
