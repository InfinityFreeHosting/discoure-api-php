<?php
/**
 * InlineResponse20047Tl3RequirementsPenaltyCounts
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * InlineResponse20047Tl3RequirementsPenaltyCounts Class Doc Comment
 *
 * @category Class
 * @package  InfinityFree\DiscourseApi
 * @author   OpenAPI Generator team
 ...
 */
class InlineResponse20047Tl3RequirementsPenaltyCounts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'inline_response_200_47_tl3_requirements_penalty_counts';
    ...
    {
        $this->container['silenced'] = $data['silenced'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['silenced'] === null) {
            $invalidProperties[] = "'silenced' can't be null";
        }
